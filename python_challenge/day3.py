...
def get_from_dict(dic, word=None):
    if type(dic) is not dict:
        ...
        print(f"{word} was not found in this dictionary.")
    else:
        print(f"{word}: {dic.get(word)}")


def update_word(dic, word, defi=None):
    if type(dic) is not dict:
        print(f"You need to send a dictionary. You sent: {type(dic)}")
    elif defi is None:
        print(f"You need to send a word and a definition.")
        ...
        dic[word] = defi
        print(f"{word} has been update to: {defi}")


def delete_from_dict(dic, word=None):
    if type(dic) is not dict:
        print(f"You need to sent a dictionary. You sent: {type(dic)}")
    elif word is None:
